...
var main = function () { return __awaiter(void 0, void 0, void 0, function () {
    var params, importer, add, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                importer = new export_ts_1.Importer(params);
                return [4 /*yield*/, importer.connect()];
            case 1:
                _a.sent();
                add = importer.getFunction("add");
                return [4 /*yield*/, add({ a: 10, b: 20 })];
            case 2:
                result = _a.sent();
